...
const Home = () => {
  ...
  useGSAP(() => {
    const h1Split = new SplitType(h1Ref.current, {
      types: "lines, words, chars",
      tagName: "span",
    });
    const h2Split = new SplitType(h2Ref.current, {
      types: "lines, words, chars",
      tagName: "span",
    });
  ...
  return (
    <div className="bg-[#0A1817] min-h-screen">
      ...
      <section
        ref={aboutRef}
        id="about"
        className="px-6 mt-40 md:px-12 lg:px-32 py-10"
      >
        <About />
      </section>
      ...
      <section
        ref={contactRef}
        id="contact"
        className="px-6 md:px-12 lg:px-32 py-10"
      >
        <Contact />
      </section>
